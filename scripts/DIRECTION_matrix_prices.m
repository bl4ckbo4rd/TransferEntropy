function DIRECTION_matrix_prices(w,w_step,m,step,clop)
...
for din = din_members
    ...
    if clop == 1
        ...
        S2 = strcat('../STE_matrices/close/m=',num2str(m),'/DIRECTION_time_matrices/w=',num2str(w),'_step=',num2str(step),'_DIR_prices.mat');
    elseif clop ==2
