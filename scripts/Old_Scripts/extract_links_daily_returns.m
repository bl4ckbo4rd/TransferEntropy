...
%threshold set at 0.1, the effective number of links and information are
%calculated by applying a Fermi-Dirac distribution.

function th = extract_links_daily_returns(din,w,w_step,m,step,a,clop)
