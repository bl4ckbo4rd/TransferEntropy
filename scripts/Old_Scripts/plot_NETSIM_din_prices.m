function plot_NETSIM_din_prices(w,w_step,m,step,criterion,clop)

%this function plots the NETSIM, number of removed links and number of
%formed links for prices as a function of time
...
for din = din_members
    ...
    if clop == 1
        S1 = strcat('../STE_matrices/close/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/criterion=',num2str(criterion),'/LINKS_prices_din=',num2str(din+w_step),'.mat');
        S2 = strcat('../STE_matrices/close/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/criterion=',num2str(criterion),'/LINKS_prices_din=',num2str(din),'.mat');
    elseif clop ==2
        S1 = strcat('../STE_matrices/open/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/criterion=',num2str(criterion),'/LINKS_prices_din=',num2str(din+w_step),'.mat');
        S2 = strcat('../STE_matrices/open/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/criterion=',num2str(criterion),'/LINKS_prices_din=',num2str(din),'.mat');
    end
