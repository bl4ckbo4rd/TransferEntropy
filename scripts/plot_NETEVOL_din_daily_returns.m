%this function plots the NETEVOL for daily geometric returns STE matrix as a function of time

function plot_NETEVOL_din_daily_returns(w,w_step,m,step,measure,clop)
...
for din = din_members
    ...
    if clop == 1
        S1 = strcat('../STE_matrices/close/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/LINKS_matrices/LINKS_daily_returns_din=',num2str(din+w_step),'.mat');
        S2 = strcat('../STE_matrices/close/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/LINKS_matrices/LINKS_daily_returns_din=',num2str(din),'.mat');
    elseif clop ==2
        S1 = strcat('../STE_matrices/open/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/LINKS_matrices/LINKS_daily_returns_din=',num2str(din+w_step),'.mat');
        S2 = strcat('../STE_matrices/open/m=',num2str(m),'/w=',num2str(w),'_step=',num2str(step),'/LINKS_matrices/LINKS_daily_returns_din=',num2str(din),'.mat');
    end
