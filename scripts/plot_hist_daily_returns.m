...
%entries of the STE matrix of the real daily geometric returns (blue) and
%that of the randomized ones (red)
%nb: randomised daily geometric returns are obtained first taking the AAFT
%of the real prices, and then computing the daily geometric returns from
%this randomised time series.

function plot_hist_daily_returns(din,w,w_step,m,step,clop)
